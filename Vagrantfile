...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "dikonikon-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/dikonikon"
  #   chef.validation_client_name = "dikonikon-validator"
  #   chef.validation_key_path = ".chef/dikonikon-validator.pem"
  # end
end
